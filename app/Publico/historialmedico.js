document.addEventListener('DOMContentLoaded',async ()=>{ 
    ...
    console.log(id)
    const res=await fetch('https://vet-2-care-integradora.onrender.com/api/getHistorial',{
        method:"POST",
            headers:{
    ...
    const an=await fetch('https://vet-2-care-integradora.onrender.com//api/getAnimal',{
        method:"POST",
            headers:{
                "Content-Type" : "application/json"
            },
