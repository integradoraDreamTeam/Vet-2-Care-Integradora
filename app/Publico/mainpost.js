document.addEventListener('DOMContentLoaded', async (req)=>{
    try{
        ...
        const an= await fetch('https://vet-2-care-integradora.onrender.com/api/getPets',{
            method:"POST",
            headers:{
                "Content-Type" : "application/json"
            },
        ...
        const cit=await fetch('https://vet-2-care-integradora.onrender.com/api/getCitas',{
            method:"POST",
            headers:{
                "Content-Type" : "application/json"
            },
